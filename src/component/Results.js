...
const saveUserToScoreboard = () => {    
  ...
  return (
    <Container className="resultsBackgroundColor  primaryColor center whiteSpaceUnderNav">
      {props.gameResults === "win1" && (
        <Row>
          <Col>
            <h1>{props.players[0].name} WON!!!</h1>
          </Col>
        </Row>
      )}
      {props.gameResults === "win2" && (
        <Row>
          <Col>
            <h1>{props.players[1].name} WON!!!</h1>
          </Col>
        </Row>
      )}
      ...
      <Row>
        ...
        <Col >
          <h5>Player1: {props.player1Total}</h5>
        </Col>
        <Col >
          <h5>Player2: {props.player2Total}</h5>
        </Col>
      </Row>
      {props.money > 0 &&
        <div>
